...
const std::vector<DWORD> CLIMB_ANGLE_OFFSETS = { 0x018EE218, 0x2d4, 0x38, 0x4 };
const std::vector<DWORD> VELOCITY_OFFSETS = { 0x018EE218, 0x2d0, 0x168 };
/* ------------------------------------------- */
